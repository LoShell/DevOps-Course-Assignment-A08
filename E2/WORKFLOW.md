...
1. 完成 `full-check-review.md` 并推送。
2. 拉取最新内容，完成 `incremental-check-review.md` 并推送。
3. 拉取最新内容，完成 Backlog、ADR 和 AI 使用记录并推送。
4. 拉取全部内容，完成沟通记录和最终评审汇总并推送。
5. 根据 Git 历史回填 `CONTRIBUTIONS.md` 中的 Commit SHA。
6. 检查材料后，将 `a08/e2-review` 合并到 `main`。
